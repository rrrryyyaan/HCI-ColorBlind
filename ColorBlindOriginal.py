...
def export(current, pressed, delay):
    if (path.exists('testResultsOriginal.csv')):
        with open ('testResultsOriginal.csv', 'a') as csv_file:
            csv_writer = csv.writer(csv_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
            csv_writer.writerow([colorToString(current),(pressed), delay])
    else:
        with open ('testResultsOriginal.csv', 'w') as csv_file:
            csv_writer = csv.writer(csv_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
            csv_writer.writerow([colorToString(current), (pressed), delay])
